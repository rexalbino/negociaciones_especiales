...
-->
        <div id="des" class="col s12 m9 l12">
           <h3>Bienvenido administrador a concesionarios</h3>
            <p>En este menu puedes consultar editar añadir y eliminar concesionarios</p>
         <table class="container highlight responsive-table">
        <thead>
          <tr>
              <th>Nombre de concesionario</th>
              <th>Editar</th>
              <th>Borrar</th>
		...
		?>
            ...
            <td><?php  echo "<a href=actualizar.php?id={$row['id_concerionario']}><i class='material-icons'>mode_edit</i></a>";?></td>
            <td><?php  echo "<a href=beforedelete.php?id={$row['id_concerionario']}><i class='material-icons'>delete</i></a>";?></td>
                </tr>
