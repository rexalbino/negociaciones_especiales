...
-->
		...
		?>
            <tr>
            <td><?php  echo $row2['des_segmento']; ?></td>
            <td><?php  echo "<a href=actualizar.php?id={$row2['id_segmento']}><i class='material-icons'>mode_edit</i></a>";?></td>
            <td><?php  echo "<a href=beforedelete.php?id={$row2['id_segmento']}><i class='material-icons'>delete</i></a>";?></td>
                </tr>
