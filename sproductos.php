...
-->
        <div id="des" class="col s12 m9 l12">
           <h3>Bienvenido administrador a tipo de productos </h3>
            <p>En este menu puedes consultar editar añadir y eliminar los productos</p>
		...
		?>
            <tr>
            <td><?php  echo $row['des_producto']; ?></td>
            <td><?php  echo $row['precio_camion']; ?></td>
            <td><?php  echo "<a href=actualizar.php?id={$row['id_producto']}><i class='material-icons'>mode_edit</i></a>";?></td>
            <td><?php  echo "<a href=beforedelete.php?id={$row['id_producto']}><i class='material-icons'>delete</i></a>";?></td>
                </tr>
